...
const VerejneObstaravanie = () => {
    ...
    return(
        <div className="w-full flex justify-evenly my-8 flex-wrap">
            <h2 className="font-bold w-full text-center md:text-5xl text-3xl mt-20 mb-8">Koho môžeš kontrolovať?</h2>

            <div onClick={showContent} className="sm:w-1/4 w-full mx-4 bg-gray-100 relative rounded-md my-8">
                ...
                <div className="w-full scale-y-0 transform origin-top transition duration-200 ease-out  bg-gray-100 text-center font-medium rounded-b-md relative z-10">
            ...
            <h2 className="font-bold w-full text-center md:text-5xl text-3xl mt-20 mb-8 ">Čo musia obstarávatelia dodržať?</h2>
            <div className="md:w-2/3 bg-gray-100 rounded-md p-8 m-2">
